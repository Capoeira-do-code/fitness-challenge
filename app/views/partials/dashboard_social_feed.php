        ...
        <?php foreach ($feedItems as $feedItem): ?>
            ...
            <article class="home-feed-post" id="feed-<?= e($feedType) ?>-<?= $feedId ?>">
                ...
                <?php elseif ($feedType === 'photo'): ?>
                    <div class="home-feed-photo-copy"><h3><?= e(trim((string) ($feedItem['caption'] ?? '')) ?: t('feed.meal_update')) ?></h3><?php if ((float) ($feedItem['calories'] ?? 0) > 0): ?><p><strong><?= e($feedNumber((float) $feedItem['calories'])) ?> kcal</strong><?php if ((float) ($feedItem['protein_g'] ?? 0) > 0): ?> · <?= e($feedNumber((float) $feedItem['protein_g'], ' g')) ?> <?= e(t('feed.protein')) ?><?php endif; ?></p><?php endif; ?></div>
                ...
                <?php else: ?>
                    <div class="home-feed-meal"><span aria-hidden="true"><?= activity_icon_svg('image') ?></span><div><p class="eyebrow"><?= e(t('feed.meal_update')) ?></p><h3><?= e(trim((string) ($feedItem['notes'] ?? '')) ?: ucfirst((string) ($feedItem['meal_type'] ?? t('feed.meal_update')))) ?></h3><strong><?= e($feedNumber((float) ($feedItem['calories'] ?? 0))) ?> kcal</strong><p><?= e($feedNumber((float) ($feedItem['protein_g'] ?? 0), ' g')) ?> P · <?= e($feedNumber((float) ($feedItem['carbs_g'] ?? 0), ' g')) ?> C · <?= e($feedNumber((float) ($feedItem['fat_g'] ?? 0), ' g')) ?> G</p></div></div>
                <?php endif; ?>
