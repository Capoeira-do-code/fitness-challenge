...
<section class="auth-wrap setup-wrap">
    <div class="panel auth-card setup-card">
        ...
        <form method="post" action="/?page=setup" class="stack setup-form" autocomplete="off">
            ...
            <fieldset>
                <legend><?= e(t('setup.site_settings_legend')) ?></legend>
                <div class="setup-grid">
                    <label><span><?= e(t('setup.app_name_label')) ?></span><input type="text" name="app_name" maxlength="80" value="<?= e((string) ($values['app_name'] ?? '')) ?>" required></label>
            ...
            <fieldset>
                <legend><?= e(t('setup.admin_account_legend')) ?></legend>
                <div class="setup-grid">
                    <label><span><?= e(t('setup.display_name_label')) ?></span><input type="text" name="display_name" maxlength="80" value="<?= e((string) ($values['display_name'] ?? '')) ?>" autocomplete="name" required autofocus></label>
