...
<section class="screen stack-lg">
    ...
    <div class="metric-grid">
        ...
        <article class="metric-card"><div class="progress-ring" style="--value: <?= e((string) ($metric['workout_completion_pct'] ?? 0)) ?>;"><span><?= e((string) ($metric['workout_completion_pct'] ?? 0)) ?>%</span></div><div><span><?= e(t('metric.workouts')) ?></span><strong><?= e((string) ($metric['workout_success'] ?? 0)) ?>/<?= e((string) ($metric['workout_target'] ?? 0)) ?></strong><p><?= e(t('metric.progress')) ?></p></div></article>
